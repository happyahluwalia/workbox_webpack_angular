/*
ng eject --target production --environment prod -op dist --aot true --base-href http://localhost:4200 --deploy-url http://localhost:4200 --verbose true --watch true --poll 5000
*/
...
module.exports = {
  ...
  "plugins": [
    ...
    new GlobCopyWebpackPlugin({
      ...
      "globOptions": {
        "cwd": "C:\\projects\\angular\\udemyangular\\temp\\github\\workbox_webpack_angular\\src",
        "dot": true,
        "ignore": "**/.gitkeep"
      }
    }),
